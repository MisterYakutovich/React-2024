  ...
  return (
    <div className='section-form'>
      ...
      <div className="input-container ic1">
        ...
        <div className="input-container ic1">
        <label>email</label>
        <input placeholder="email" type="email" ref={emailRef} className="input"/>
        <br />
        </div>
        <div className="input-container ic1">
      ...
      <br />
        ...
        <input type="checkbox" id="acceptTerms" ref={termsAndConditionsRef} className="input"/>
        <br />
        </div>
        <button className='button_un' type="submit">Submit</button>
      </form>
    </div>
  );
};
